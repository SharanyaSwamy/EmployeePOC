...
public class SpringRestClient {
    ...
    private static final String GET_EMPLOYEE_ENDPOINT_URL = "http://localhost:8080/api/employees/{id}";
    private static final String CREATE_EMPLOYEE_ENDPOINT_URL = "http://localhost:8080/api/employees";
    private static final String UPDATE_EMPLOYEE_ENDPOINT_URL = "http://localhost:8080/api/employees/{id}";
    ...
    private void createEmployee() {
        ...
        Employee newEmployee = new Employee("admin", 5000, "Administration");
    ...
    private void updateEmployee() {
        Map < String, String > params = new HashMap < String, String > ();
        params.put("id", "1");
        Employee updatedEmployee = new Employee("admin KP", 5000, "Administration");
        RestTemplate restTemplate = new RestTemplate();
